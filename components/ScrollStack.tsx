...
const ScrollStack: React.FC<ScrollStackProps> = ({
  ...
  useLayoutEffect(() => {
    ...
    onStackComplete, setupScrollListener, updateCardTransforms, handleScroll,
  ]);
  ...
  const containerStyles: React.CSSProperties = {
    ...
    ...(useWindowScroll ? {} : { scrollBehavior: 'smooth' as const, willChange: 'scroll-position' }),
  };

  return (
    <div className={containerClassName} ref={scrollerRef} style={containerStyles}>
      <div className="scroll-stack-inner px-4 sm:px-6 lg:px-20 pb-[50rem] min-h-screen">
        {children}
